    ...
    return (
        <nav className="z-50 fixed top-0 h-20 w-full">
            <div className="relative">
                ...
                >
                    ...
                    >
                        ...
                        <ul className="-mr-3 sm:-mr-5 grid grid-flow-col justify-end items-center">
                            <NavBarItem
                                name="docs" href="https://laravel.com/docs" icon="fab fa-laravel"
                                important
                            />
                            <NavBarItem
                                name="settings" icon="fas fa-cog" label={false}
                ...
                <div
                    id="navbar-exception" className="absolute top-0 left-0 w-full
