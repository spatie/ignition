                    ...
                    <div className="flex items-center">
                        ...
                        >
                            <svg className="w-4 h-5 mr-4" viewBox="0 0 428 988">
                                <polygon style={{ fill: '#FA4E79' }} points="428,247.1 428,494.1 214,617.5 214,369.3" />
                                <polygon style={{ fill: '#FFF082' }} points="0,988 0,741 214,617.5 214,864.1" />
                                <polygon style={{ fill: '#E6003A' }} points="214,123.9 214,617.5 0,494.1 0,0" />
                                <polygon style={{ fill: '#FFE100' }} points="214,864.1 214,617.5 428,741 428,988" />
                            </svg>
                        </a>
