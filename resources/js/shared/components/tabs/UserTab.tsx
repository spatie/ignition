        ...
        <div className="tab-content">
            <div className="layout-col">
                <DefinitionList title="User Data" className="tab-content-section border-none">
                    {user.email && <DefinitionList.Row value={<img src={gravatar} />} label="Gravatar" />}
                ...
                <DefinitionList title="Client info" className="tab-content-section">
                    ...
                    {request.flare_user_agent_platform && (
                        <DefinitionList.Row value={request.flare_user_agent_platform} label="Platform" />
                    )}
                    {request.flare_user_agent_device && (
                        <DefinitionList.Row value={request.flare_user_agent_device} label="Device" />
                    )}
                    {request.flare_user_agent_browser && (
                        <DefinitionList.Row value={request.flare_user_agent_browser} label="Browser" />
                    )}
                    {request.flare_user_agent_browser_version && (
                        <DefinitionList.Row value={request.flare_user_agent_browser_version} label="Browser version" />
                    )}
                </DefinitionList>
            </div>
        </div>
